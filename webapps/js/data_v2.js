...
function buildCalendar() {
  ...
  const monthList2 = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'];
  const leapYear = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
  const notLeapYear = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
  const headerYear = document.querySelector('.current-year-month');
  const headerYear2 = document.querySelector('.current-year-month2');
  // 윤년 체크하기
  ...
  headerYear.innerHTML = `${today.getFullYear()}년&nbsp;&nbsp;${monthList[firstDate.getMonth()]}월`;
  headerYear2.innerHTML = `${today.getFullYear()}년&nbsp;${monthList2[firstDate.getMonth()]}월`;
